...
p.nominalBounds = new cjs.Rectangle(455.2,945,89.9,10.1);


// stage content:
(lib.preloader4 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 2
	this.instance = new lib.Symbol1();
	this.instance.parent = this;
	this.instance.setTransform(886.3,-244.9,1,1,0,0,0,294.1,143);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#F6F6F6").s().p("EhzaATnMAAAgnNMDm1AAAMAAAAnNg");
	this.shape.setTransform(1127.8,200.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.instance}]}).wait(70));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Bitmap1.jpg?1503325359559", id:"Bitmap1"}
	],
	preloads: []
};
