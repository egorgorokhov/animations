...
(lib.round = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#FFD400").s().p("AhGBHQgdgdAAgqQAAgpAdgcQAdgeApAAQApAAAdAeQAeAcAAApQAAAqgeAdQgdAdgpAAQgpAAgdgdg");
...
// stage content:
(lib.preloader2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
